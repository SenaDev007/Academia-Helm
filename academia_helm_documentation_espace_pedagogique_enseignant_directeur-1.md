...
Enseignant prépare → Enseignant soumet → Directeur reçoit → Directeur contrôle → Directeur valide ou rejette → Enseignant corrige si nécessaire → Document archivé.

---

## 2. Principe fondamental

Chaque enseignant dispose d’un espace personnel. Il ne voit que ses propres documents pédagogiques, ses propres soumissions, ses propres retours, ses propres validations et ses propres rejets.
...
Sara AI ne remplace ni l’enseignant ni le Directeur.
