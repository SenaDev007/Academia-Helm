...
export class FinancialSettingsService {
  ...
  async update(
    ...
    if (data.blockingThreshold != null) payload.blockingThreshold = new Decimal(data.blockingThreshold);
    if (data.allowPartialPayment != null) payload.allowPartialPayment = data.allowPartialPayment;
    if (data.minimumInstallmentAmount !== undefined) payload.minimumInstallmentAmount = data.minimumInstallmentAmount == null ? null : new Decimal(data.minimumInstallmentAmount);
    ...
    if (data.expenseReceiptThreshold !== undefined) payload.expenseReceiptThreshold = data.expenseReceiptThreshold == null ? null : new Decimal(data.expenseReceiptThreshold);
