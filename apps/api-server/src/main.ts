  ...
  try {
    ...
    const alterStatements = [
      ...
      `INSERT INTO "pricing_plans" ("id", "code", "name", "tagline", "description", "studentMin", "studentMax", "initialFee", "monthlyAmount", "yearlyAmount", "bilingualMonthly", "bilingualYearly", "features", "isPopular", "isActive", "sortOrder", "createdAt", "updatedAt")
       SELECT gen_random_uuid(), 'SEED', 'Helm Seed', 'L''essentiel pour bien démarrer', 'Idéal pour les petites écoles qui démarrent leur transformation numérique.', 1, 150, 75000, 19900, 199000, 10000, 100000, '["Tous les modules inclus sans restriction","Jusqu''à 150 élèves","Essai gratuit 30 jours","Support par email","Sauvegarde automatique (restauration 24h)"]', false, true, 1, NOW(), NOW()
       WHERE NOT EXISTS (SELECT 1 FROM "pricing_plans" WHERE "code" = 'SEED')`,
      `INSERT INTO "pricing_plans" ("id", "code", "name", "tagline", "description", "studentMin", "studentMax", "initialFee", "monthlyAmount", "yearlyAmount", "bilingualMonthly", "bilingualYearly", "features", "isPopular", "isActive", "sortOrder", "createdAt", "updatedAt")
       SELECT gen_random_uuid(), 'GROW', 'Helm Grow', 'Pilotez votre croissance', 'Pour les écoles en pleine expansion qui ont besoin d''outils avancés.', 151, 400, 100000, 24900, 249000, 10000, 100000, '["Tous les modules inclus sans restriction","151 à 400 élèves","Essai gratuit 30 jours","Support prioritaire email + WhatsApp","Sauvegarde automatique (restauration 24h)","Tableaux de bord ORION"]', true, true, 2, NOW(), NOW()
       WHERE NOT EXISTS (SELECT 1 FROM "pricing_plans" WHERE "code" = 'GROW')`,
      `INSERT INTO "pricing_plans" ("id", "code", "name", "tagline", "description", "studentMin", "studentMax", "initialFee", "monthlyAmount", "yearlyAmount", "bilingualMonthly", "bilingualYearly", "features", "isPopular", "isActive", "sortOrder", "createdAt", "updatedAt")
       SELECT gen_random_uuid(), 'LEAD', 'Helm Lead', 'Dominez votre marché', 'Pour les grandes écoles qui veulent un pilotage avancé et l''analytics.', 401, 800, 150000, 39900, 399000, 10000, 100000, '["Tous les modules inclus sans restriction","401 à 800 élèves","Essai gratuit 30 jours","Support dédié 7j/7","Sauvegarde automatique (restauration 1h)","Tableaux de bord ORION + alertes intelligentes"]', false, true, 3, NOW(), NOW()
       WHERE NOT EXISTS (SELECT 1 FROM "pricing_plans" WHERE "code" = 'LEAD')`,
      `INSERT INTO "pricing_plans" ("id", "code", "name", "tagline", "description", "studentMin", "studentMax", "initialFee", "monthlyAmount", "yearlyAmount", "bilingualMonthly", "bilingualYearly", "features", "isPopular", "isActive", "sortOrder", "createdAt", "updatedAt")
       SELECT gen_random_uuid(), 'NETWORK', 'Helm Network', 'La catégorie multi-campus', 'Pour les réseaux d''écoles et les établissements multi-campus.', 801, NULL, 200000, NULL, NULL, 10000, 100000, '["Tous les modules inclus sans restriction","Plus de 800 élèves","Essai gratuit 30 jours","Account manager dédié","Sauvegarde temps réel + réplication","Tableaux de bord ORION + alertes intelligentes","Gestion multi-écoles","Formation sur site"]', false, true, 4, NOW(), NOW()
      ...
      `UPDATE "pricing_plans" SET "features" = '["Tous les modules inclus sans restriction","Jusqu''à 150 élèves","Essai gratuit 30 jours","Support par email","Sauvegarde automatique (restauration 24h)"]', "updatedAt" = NOW() WHERE "code" = 'SEED'`,
      `UPDATE "pricing_plans" SET "features" = '["Tous les modules inclus sans restriction","151 à 400 élèves","Essai gratuit 30 jours","Support prioritaire email + WhatsApp","Sauvegarde automatique (restauration 24h)","Tableaux de bord ORION"]', "updatedAt" = NOW() WHERE "code" = 'GROW'`,
      `UPDATE "pricing_plans" SET "features" = '["Tous les modules inclus sans restriction","401 à 800 élèves","Essai gratuit 30 jours","Support dédié 7j/7","Sauvegarde automatique (restauration 1h)","Tableaux de bord ORION + alertes intelligentes"]', "updatedAt" = NOW() WHERE "code" = 'LEAD'`,
      `UPDATE "pricing_plans" SET "features" = '["Tous les modules inclus sans restriction","Plus de 800 élèves","Essai gratuit 30 jours","Account manager dédié","Sauvegarde temps réel + réplication","Tableaux de bord ORION + alertes intelligentes","Gestion multi-écoles","Formation sur site"]', "updatedAt" = NOW() WHERE "code" = 'NETWORK'`,
