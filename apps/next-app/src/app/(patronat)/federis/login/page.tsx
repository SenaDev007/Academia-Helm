  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const testCredentials = [
        { email: 'federis@test.com', password: 'federis123', role: 'PATRONAT_ADMIN' },
      ...
      if (testUser) {
        ...
        const sessionData = {
          user: {
            id: `test-federis-user-${Date.now()}`,
            email: testUser.email,
            firstName: 'Test',
            lastName: 'Federis',
            role: testUser.role,
            tenantId: 'test-federis-tenant-id',
          },
          token: 'test-federis-token-' + Date.now(),
      ...
      // TODO: Appel API connexion federis
      // const response = await fetch('/api/federis/login', { ... });
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-xs text-blue-800 space-y-1">
              <p>• <strong>federis@test.com</strong> / federis123 (Admin)</p>
