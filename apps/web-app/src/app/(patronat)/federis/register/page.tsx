/**
 * Page d'inscription Federis
 * 
 * Création de compte pour federiss et organismes d'examen
...
export default function FederisRegisterPage() {
  ...
  const validateStep = (stepNumber: number): boolean => {
    ...
    if (stepNumber === 1) {
      if (!formData.name.trim()) newErrors.name = 'Le nom du federis est requis';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // TODO: Appel API création compte federis
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Créer un compte Federis / Organisme d'examen
            </h1>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ex: Federis des Écoles Privées du Bénin"
                  />
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="PATRONAT">Federis d'écoles privées</option>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="contact@federis.bj"
                  />
