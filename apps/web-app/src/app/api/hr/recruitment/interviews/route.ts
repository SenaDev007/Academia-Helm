/**
 * ============================================================================
 * API PROXY - RECRUITMENT INTERVIEWS
 * ============================================================================
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch recruitment interviews' }, { status: 500 });
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to create recruitment interview' }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to update recruitment interview' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete recruitment interview' }, { status: 500 });
  }
}
