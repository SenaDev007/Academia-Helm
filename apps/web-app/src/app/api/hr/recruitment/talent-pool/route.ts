/**
 * ============================================================================
 * API PROXY - RECRUITMENT TALENT POOL
 * ============================================================================
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${API_BASE_URL}/hr/recruitment/talent-pool${queryString ? `?${queryString}` : ''}`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/hr/recruitment/talent-pool`, {
      method: 'POST',
      headers: {
