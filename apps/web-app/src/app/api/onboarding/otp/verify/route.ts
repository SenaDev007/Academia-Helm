/**
 * ============================================================================
 * ONBOARDING OTP VERIFY API ROUTE
 * ============================================================================
 * 
 * Proxy Next.js pour vérifier un code OTP
 * 
 * ============================================================================
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const otpUrl = `${apiBaseUrl}/onboarding/draft/${draftId}/otp/verify`;

    console.log('🔍 [OTP Verify] API URL:', otpUrl);
    ...
    console.error('Onboarding OTP verify API error:', error);
    return NextResponse.json(
      { 
