...
function CareersContent() {
  ...
  // LinkedIn Easy Apply Multi-Step Form States
  ...
  // Step 2: Work Experience List (LinkedIn style)
      ...
      <main className="flex-grow pt-28 pb-20 px-4 md:px-8 max-w-6xl mx-auto w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm md:text-base text-slate-500 mt-2 max-w-xl mx-auto">
            Postulez instantanément grâce à notre parcours de candidature LinkedIn-Style intégrant l'analyse IA.
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredSchools.map((school) => (
                    <div
                      ...
                      className="group cursor-pointer bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between"
                    >
                      <div>
                        <div className="h-12 w-12 rounded-xl bg-blue-50/80 border border-blue-100 flex items-center justify-center text-[#1A2BA6] mb-4">
            ...
            {selectedSchool && (
              <motion.div key="step-jobs" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-6">
                ...
                {!isApplying ? (
                    ...
                    <div className="lg:col-span-2">
                      {selectedJob ? (
                        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
                          ...
                          >
                            <Linkedin className="h-4 w-4 fill-white" /> Postuler avec Easy Apply
                          </button>
                        </div>
                      ) : (
                  ...
                  /* Form: Easy Apply LinkedIn style multi-step */
                      ...
                      <div className="text-center py-8 space-y-4">
                        {submitResult.success ? (
                          <>
                            ...
                            <h4 className="font-bold text-slate-900 text-base">Candidature LinkedIn Easy Apply Transmise</h4>
