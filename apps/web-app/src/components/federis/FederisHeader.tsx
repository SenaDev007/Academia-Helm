/**
 * FederisHeader - Header Premium Institutionnel
 * 
 * Header marketing pour le module Federis & Examens Nationaux
 * Utilisé uniquement sur les pages marketing : /federis, /federis/*
...
export default function FederisHeader() {
  ...
  const menuItems = [
    { path: '/federis-examens#fonctionnalites', label: 'Fonctionnalités' },
    { path: '/federis-examens#processus', label: 'Processus Examens' },
    { path: '/federis-examens#banque-epreuves', label: 'Banque d\'épreuves' },
    { path: '/federis-examens#securite', label: 'Sécurité & Conformité' },
    { path: '/federis-examens#tarification', label: 'Tarification Federis' },
  ];
