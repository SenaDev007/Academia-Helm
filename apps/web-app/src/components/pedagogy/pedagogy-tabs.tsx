...
export const PEDAGOGY_SUBMODULE_TABS = [
  ...
  },
  {
    ...
    icon: Layers,
    roles: ['SUPER_DIRECTOR', 'PLATFORM_OWNER', 'SCHOOL_OWNER', 'SCHOOL_ADMIN', 'PROMOTER', 'director', 'admin', 'DIRECTEUR_GENERAL', 'DIRECTEUR_ETABLISSEMENT', 'CENSEUR', 'RESP_SECONDAIRE', 'RESP_PRIMAIRE', 'RESP_MATERNELLE', 'PEDAGOGIC_DIRECTOR', 'PEDAGOGIC_COORDINATOR'],
  },
  {
    id: 'subjects',
