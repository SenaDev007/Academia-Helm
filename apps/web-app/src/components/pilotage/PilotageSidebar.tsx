...
export default function PilotageSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-72 z-[60] lg:hidden flex flex-col bg-blue-900 text-white shadow-2xl transition-transform duration-300 ease-in-out ${
      ...
      <aside
        className="hidden md:flex lg:hidden fixed left-0 top-[56px] h-[calc(100vh-56px)] w-16 flex-col bg-blue-900 text-white z-40 shadow-xl"
      ...
      <aside
        className={`hidden lg:flex fixed left-0 top-[56px] h-[calc(100vh-56px)] bg-blue-900 text-white transition-all duration-300 ease-in-out z-40 shadow-xl flex-col ${
          isOpen ? 'w-64' : 'w-16'
        }`}
