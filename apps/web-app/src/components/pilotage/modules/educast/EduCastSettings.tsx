...
import { Settings, Bell, ShieldCheck, Database, Layout, Save, RefreshCw, Trash2, Sliders, MonitorPlay } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <select className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-slate-900 font-black outline-none focus:ring-2 focus:ring-blue-500/20 transition-all appearance-none">
            ...
            <div className="space-y-3">
              ...
              <input type="number" defaultValue={5} className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-slate-900 font-black outline-none focus:ring-2 focus:ring-blue-500/20 transition-all" />
            </div>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input type="number" defaultValue={50} className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-slate-900 font-black outline-none focus:ring-2 focus:ring-rose-500/20 transition-all" />
            </div>
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Auto-archivage après (Mois)</label>
              <input type="number" defaultValue={24} className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-slate-900 font-black outline-none focus:ring-2 focus:ring-rose-500/20 transition-all" />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
            ...
            <div className="w-12 h-6 bg-amber-600 rounded-full p-1 flex justify-end cursor-pointer">
              <div className="w-4 h-4 bg-white rounded-full shadow-sm" />
            </div>
          </div>
        </motion.div>
