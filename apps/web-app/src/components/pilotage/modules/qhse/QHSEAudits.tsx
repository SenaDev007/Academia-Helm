...
import { ClipboardList, Calendar, User, Star, ArrowUpRight, CheckCircle2, Search, Filter, Plus, ChevronRight, Loader2 } from 'lucide-react';
...
export default function QHSEAudits() {
  ...
  const { data: audits, loading, error } = useModulesList<AuditItem>('qhse', 'audits', academicYear?.id);
