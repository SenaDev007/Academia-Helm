...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs text-gray-400 mt-2">Lun-Jeu 8h-18h, Ven 8h-16h (GMT+1)</p>
              </div>
            </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  ...
                  <div className="space-y-1 text-xs text-gray-500">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-700">8h — 18h (GMT+1)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Vendredi</span>
                      <span className="font-medium text-gray-700">8h — 16h (GMT+1)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Samedi</span>
                    ...
                    <div className="flex justify-between">
                      <span>Dimanche</span>
                      <span className="font-medium text-gray-700">9h — 17h (GMT+1)</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      >
        <WhatsAppIcon className="w-7 h-7 text-white group-hover:animate-pulse" />
        {/* Tooltip */}
