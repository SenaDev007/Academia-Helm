/**
 * Signature Canvas — version publique (sans dépendance au module admin)
 *
 * Composant réutilisable pour dessiner une signature à la souris/au doigt.
 * Retourne un data URL base64 (PNG) via onSignatureChange.
 */
        ...
        className={`relative rounded-xl border-2 transition-colors overflow-hidden ${
          disabled
            ...
            : hasSignature
              ...
              : 'border-dashed border-slate-300 bg-white hover:border-blue-500'
        }`}
      >
        <canvas
          ref={canvasRef}
