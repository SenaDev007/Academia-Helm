...
export const PAGE_NAMES: Record<string, string> = {
  ...
  // ─── App — Plateforme ───
  '/app/platform': 'Plateforme',
  '/app/platform/orion-pilotage': 'ORION Pilotage',
  '/app/platform/support': 'Support',
  '/app/platform/payments': 'Paiements',
  '/app/platform/aggregation': 'Agrégation',
  '/app/platform/settings': 'Paramètres Plateforme',
  '/app/platform/billing': 'Facturation Plateforme',
  '/app/platform/tenants': 'Établissements',
  '/app/platform/users': 'Utilisateurs',
  '/app/platform/subscriptions': 'Abonnements',
  '/app/platform/initial-subscriptions': 'Abonnements initiaux',
  '/app/platform/orion': 'ORION',
  '/app/platform/rbac': "Droits d'accès (RBAC)",
  '/app/platform/audit': 'Audit',
  '/app/platform/monitoring': 'Monitoring',
  '/app/platform/modules': 'Modules',
